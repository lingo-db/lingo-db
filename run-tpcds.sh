...
#./build/lingodb-debug/run-sql resources/sql/tpcds/12.sql resources/data/tpcds-1 window functions
#./build/lingodb-debug/run-sql resources/sql/tpcds/13.sql resources/data/tpcds-1
#./build/lingodb-debug/run-sql resources/sql/tpcds/14a.sql resources/data/tpcds-1 multiple problems
...
#./build/lingodb-debug/run-sql resources/sql/tpcds/16.sql resources/data/tpcds-1 order by count(distinct cs_order_number)
#./build/lingodb-debug/run-sql resources/sql/tpcds/17.sql resources/data/tpcds-1 stddev_samp aggregate function
#./build/lingodb-debug/run-sql resources/sql/tpcds/18.sql resources/data/tpcds-1 rollup
...
#./build/lingodb-debug/run-sql resources/sql/tpcds/36.sql resources/data/tpcds-1 rollup
...
#./build/lingodb-debug/run-sql resources/sql/tpcds/39a.sql resources/data/tpcds-1  ,stddev_samp
#./build/lingodb-debug/run-sql resources/sql/tpcds/39b.sql resources/data/tpcds-1  ,stddev_samp
#./build/lingodb-debug/run-sql resources/sql/tpcds/3.sql resources/data/tpcds-1
#./build/lingodb-debug/run-sql resources/sql/tpcds/40.sql resources/data/tpcds-1 error: 'db.isnull' op operand #0 must be nullable, but got 'i32'
#./build/lingodb-debug/run-sql resources/sql/tpcds/41.sql resources/data/tpcds-1
#./build/lingodb-debug/run-sql resources/sql/tpcds/42.sql resources/data/tpcds-1 order by       sum(ss_ext_sales_price) desc
#./build/lingodb-debug/run-sql resources/sql/tpcds/43.sql resources/data/tpcds-1
#./build/lingodb-debug/run-sql resources/sql/tpcds/44.sql resources/data/tpcds-1 window functions
...
#./build/lingodb-debug/run-sql resources/sql/tpcds/47.sql resources/data/tpcds-1 window functions
#./build/lingodb-debug/run-sql resources/sql/tpcds/48.sql resources/data/tpcds-1
#./build/lingodb-debug/run-sql resources/sql/tpcds/49.sql resources/data/tpcds-1 window functions
...
#./build/lingodb-debug/run-sql resources/sql/tpcds/70.sql resources/data/tpcds-1 window functions
#./build/lingodb-debug/run-sql resources/sql/tpcds/71.sql resources/data/tpcds-1
#./build/lingodb-debug/run-sql resources/sql/tpcds/72.sql resources/data/tpcds-1 no valid join order found / terminate called after throwing an instance of 'std::out_of_range'
...
#./build/lingodb-debug/run-sql resources/sql/tpcds/75.sql resources/data/tpcds-1 error: 'db.isnull' op operand #0 must be nullable, but got '!db.decimal<2, 1>'
#./build/lingodb-debug/run-sql resources/sql/tpcds/76.sql resources/data/tpcds-1 SET operation expacts same types (column:0)
...
#./build/lingodb-debug/run-sql resources/sql/tpcds/94.sql resources/data/tpcds-1 order by count(distinct ws_order_number)
#./build/lingodb-debug/run-sql resources/sql/tpcds/95.sql resources/data/tpcds-1 order by count(distinct ws_order_number)
#./build/lingodb-debug/run-sql resources/sql/tpcds/96.sql resources/data/tpcds-1 order by count(*)
