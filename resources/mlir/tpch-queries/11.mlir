module {
  func @main() -> !dsa.table {
    ...
    %6 = relalg.map @map0 %5 computes : [@tmp_attr3({type = !db.decimal<15, 2>}),@tmp_attr1({type = !db.decimal<15, 2>})] (%arg0: !relalg.tuple){
      ...
      relalg.return %14, %18 : !db.decimal<15, 2>, !db.decimal<15, 2>
    }
    %7 = relalg.aggregation @aggr0 %6 [@partsupp::@ps_partkey] computes : [@tmp_attr2({type = !db.decimal<15, 2>}),@tmp_attr0({type = !db.decimal<15, 2>})] (%arg0: !relalg.tuplestream,%arg1: !relalg.tuple){
      %11 = relalg.aggrfn sum @map0::@tmp_attr3 %arg0 : !db.decimal<15, 2>
      %12 = relalg.aggrfn sum @map0::@tmp_attr1 %arg0 : !db.decimal<15, 2>
      relalg.return %11, %12 : !db.decimal<15, 2>, !db.decimal<15, 2>
    }
    %8 = relalg.selection %7 (%arg0: !relalg.tuple){
      ...
      %18 = relalg.map @map1 %17 computes : [@tmp_attr5({type = !db.decimal<15, 2>})] (%arg1: !relalg.tuple){
        ...
        relalg.return %27 : !db.decimal<15, 2>
      }
      %19 = relalg.aggregation @aggr1 %18 [] computes : [@tmp_attr4({type = !db.nullable<!db.decimal<15, 2>>})] (%arg1: !relalg.tuplestream,%arg2: !relalg.tuple){
        %24 = relalg.aggrfn sum @map1::@tmp_attr5 %arg1 : !db.nullable<!db.decimal<15, 2>>
        relalg.return %24 : !db.nullable<!db.decimal<15, 2>>
      }
      %20 = relalg.map @map2 %19 computes : [@tmp_attr6({type = !db.nullable<!db.decimal<15, 4>>})] (%arg1: !relalg.tuple){
        ...
        relalg.return %27 : !db.nullable<!db.decimal<15, 4>>
      }
