module @querymodule{
    func  @main ()  -> !db.table{
        ...
        %6 = relalg.basetable @customer { table_identifier="customer", rows=15000 , pkey=["c_custkey"]} columns: {c_custkey => @c_custkey({type=!db.int<32>}),
        ...
        %10 = relalg.basetable @nation1 { table_identifier="nation", rows=25 , pkey=["n_nationkey"]} columns: {n_nationkey => @n_nationkey({type=!db.int<32>}),
            n_name => @n_name({type=!db.string}),
            n_regionkey => @n_regionkey({type=!db.int<32>}),
            n_comment => @n_comment({type=!db.string<nullable>})
        }
        ...
        %13 = relalg.selection %11(%12: !relalg.tuple) {
            ...
            %17 = relalg.getattr %12 @orders::@o_orderkey : !db.int<32>
            %18 = relalg.getattr %12 @lineitem::@l_orderkey : !db.int<32>
            %19 = db.compare eq %17 : !db.int<32>,%18 : !db.int<32>
            %20 = relalg.getattr %12 @customer::@c_custkey : !db.int<32>
            %21 = relalg.getattr %12 @orders::@o_custkey : !db.int<32>
            %22 = db.compare eq %20 : !db.int<32>,%21 : !db.int<32>
            %23 = relalg.getattr %12 @supplier::@s_nationkey : !db.int<32>
            %24 = relalg.getattr %12 @nation::@n_nationkey : !db.int<32>
            %25 = db.compare eq %23 : !db.int<32>,%24 : !db.int<32>
            %26 = relalg.getattr %12 @customer::@c_nationkey : !db.int<32>
            %27 = relalg.getattr %12 @nation1::@n_nationkey : !db.int<32>
