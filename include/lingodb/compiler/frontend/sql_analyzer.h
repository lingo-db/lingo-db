...
class SQLQueryAnalyzer {
   ...
   */
   ...
   std::shared_ptr<ast::TableProducer> analyzeTableFunctionRef(std::shared_ptr<ast::TableFunctionRef> tableFunctionRef, std::shared_ptr<SQLContext> context, ResolverScope& resolverScope);
