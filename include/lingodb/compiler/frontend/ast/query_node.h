...
class SelectNode : public QueryNode {
   ...
   SelectNode();
   ~SelectNode() override;
   static constexpr QueryNodeType kType = QueryNodeType::SELECT_NODE;
   //! The projection list
   std::shared_ptr<TargetsExpression> selectList;
   //! The FROM clause
...
class SetOperationNode : public QueryNode {
   static constexpr QueryNodeType kType = QueryNodeType::SET_OPERATION_NODE;
...
class ValuesQueryNode : public QueryNode {
   public:
   static constexpr QueryNodeType kType = QueryNodeType::VALUES;
   ValuesQueryNode(std::shared_ptr<ExpressionListRef> expressionListRef);
...
class CTENode : public QueryNode {
   public:
   static constexpr QueryNodeType kType = QueryNodeType::CTE_NODE;
