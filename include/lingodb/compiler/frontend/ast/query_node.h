...
class SelectNode : public QueryNode {
   public:
   SelectNode() : QueryNode(cType) {}
   static constexpr QueryNodeType cType = QueryNodeType::SELECT_NODE;
   //! The projection list
   std::shared_ptr<TargetList> selectList;
   //! The FROM clause
   std::shared_ptr<TableRef> fromClause;
   //! The WHERE clause
   std::shared_ptr<ParsedExpression> whereClause;
...
class SetOperationNode : public QueryNode {
   static constexpr QueryNodeType cType = QueryNodeType::SET_OPERATION_NODE;

   public:
   SetOperationNode(SetOperationType setType, std::shared_ptr<TableProducer> left, std::shared_ptr<TableProducer> right) : QueryNode(cType), setType(setType), left(left), right(right) {}
...
class ValuesQueryNode : public QueryNode {
   public:
   static constexpr QueryNodeType cType = QueryNodeType::VALUES;
   ValuesQueryNode(std::shared_ptr<ExpressionListRef> expressionListRef) : QueryNode(cType), expressionListRef(std::move(expressionListRef)) {}
...
class CTENode : public QueryNode {
   public:
   static constexpr const QueryNodeType cType = QueryNodeType::CTE_NODE;
