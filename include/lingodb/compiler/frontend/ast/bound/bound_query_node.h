...
class BoundValuesQueryNode : public QueryNode {
   public:
   static constexpr QueryNodeType cType = QueryNodeType::BOUND_VALUES;
   BoundValuesQueryNode(std::string alias, std::shared_ptr<BoundExpressionListRef> expressionListRef) : QueryNode(cType), expressionListRef(std::move(expressionListRef)) {}
...
class BoundCTENode : public QueryNode {
   public:
   static constexpr const QueryNodeType cType = QueryNodeType::BOUND_CTE_NODE;
