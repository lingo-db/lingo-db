...
for qnum in range(1, 21):
    ...
    proc1 = subprocess.run(
        "python3 ./tools/sql-to-mlir/sql-to-mlir.py " + file1 + " |build/build-debug-llvm-release/mlir-db-opt --relalg-extract-nested-operators --relalg-decompose-lambdas --relalg-implicit-to-explicit-joins --relalg-pushdown --relalg-unnesting | build/build-debug-llvm-release/test | build/build-debug-llvm-release/tools/mlir-to-sql/mlir-to-sql",
