...
venv/bin/python3 -m pip install build pyarrow===23.0.0
...
auditwheel repair dist/*.whl --plat "$PLAT" --exclude libarrow_python.so.2300 --exclude libarrow.so.2300 -w /built-packages
