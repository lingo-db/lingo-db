...
std::shared_ptr<db::RuntimeFunctionRegistry> db::RuntimeFunctionRegistry::getBuiltinRegistry(mlir::MLIRContext* context) {
   ...
   auto resTypeIsInterval = [](mlir::Type t, mlir::TypeRange) { return mlir::isa<db::IntervalType>(t); };
   ...
   builtinRegistry->add("DateDiffInterval").matchesTypes({RuntimeFunction::dateLike, RuntimeFunction::dateLike}, resTypeIsInterval).implementedAs(DateRuntime::dateDiffNanoSeconds);
