...
struct PyInterpLoweringPass
   ...
   virtual llvm::StringRef getArgument() const override { return "lower-py-interp"; }
   ...
   LogicalResult matchAndRewrite(py_interp::Call op, OpAdaptor adaptor, ConversionPatternRewriter& rewriter) const override {
      if (op.getKwnames().empty()) {
         ...
         switch (adaptor.getArgs().size()) {
            case 0: fn = rt::PythonRuntime::call0; break;
            case 1: fn = rt::PythonRuntime::call1; break;
            case 2: fn = rt::PythonRuntime::call2; break;
            case 3: fn = rt::PythonRuntime::call3; break;
            case 4: fn = rt::PythonRuntime::call4; break;
            case 5: fn = rt::PythonRuntime::call5; break;
            case 6: fn = rt::PythonRuntime::call6; break;
            case 7: fn = rt::PythonRuntime::call7; break;
            case 8: fn = rt::PythonRuntime::call8; break;
            case 9: fn = rt::PythonRuntime::call9; break;
            case 10: fn = rt::PythonRuntime::call10; break;
         }
