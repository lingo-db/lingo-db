...
BoundValuesQueryNode::BoundValuesQueryNode(std::string alias, std::shared_ptr<BoundExpressionListRef> expressionListRef) : QueryNode(kType), expressionListRef(std::move(expressionListRef)) {
   this->alias = alias;
}
