 ...
 module {
	...
	func.func @main () {
        ...
        %result_table=dsa.create_ds ("str!:string; float32!:float[32]; float64!:float[64]; decimal!:decimal[5,2]; int32!:int[32]; int64!:int[64]; bool:bool; date32!:date[32]; date64!:date[64]") -> !dsa.result_table<!test_table_tuple>
        ...
        dsa.for %record_batch in %0 : !dsa.iterable<!dsa.record_batch<!test_table_tuple>,table_chunk_iterator>{
            dsa.for %row in %record_batch : !dsa.record_batch<!test_table_tuple>{
                ...
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %10#0 :!db.string, %10#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %20#0 : f32, %20#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %30#0 : f64, %30#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %40#0 : !db.decimal<5,2> , %40#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %50#0 : i32, %50#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %60#0 : i64, %60#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %70#0 : i1, %70#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %80#0 :!db.date<day>, %80#1
                dsa.ds_append %result_table : !dsa.result_table<!test_table_tuple>, %90#0 :!db.date<millisecond>, %90#1

                dsa.next_row %result_table : !dsa.result_table<!test_table_tuple>
            }
        }
		dsa.set_result 0 %result_table : !dsa.result_table<!test_table_tuple>
		return
	}
 }