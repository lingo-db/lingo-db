...
!test_table_tuple=type tuple<!db.string,f32,f64,!db.decimal<5,2>,i32,i64,i1,!db.date<day>,!db.date<millisecond>>
 ...
 module {
	...
	func @main () {
	    ...
	    %vector = dsa.create_ds !dsa.vector<!test_table_tuple2>
        ...
        dsa.for %record_batch in %0 : !dsa.iterable<!dsa.record_batch<!test_table_tuple>,table_chunk_iterator>{
            dsa.for %row in %record_batch : !dsa.record_batch<!test_table_tuple>{
                ...
                dsa.ds_append %vector : !dsa.vector<!test_table_tuple2> , %packed : !test_table_tuple2
                dsa.yield
            }
            dsa.yield
        }
        dsa.for %row in %vector : !dsa.vector<!test_table_tuple2> {
            %1,%2,%3,%4,%5,%6,%7,%8,%9 = util.unpack %row : !test_table_tuple2 -> !db.nullable<!db.string>,!db.nullable<f32>,!db.nullable<f64>,!db.nullable<!db.decimal<5,2>>,!db.nullable<i32>,!db.nullable<i64>,!db.nullable<i1>,!db.nullable<!db.date<day>>,!db.nullable<!db.date<millisecond>>
