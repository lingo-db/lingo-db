...
module {
  ...
  func.func @main() {
    %result = relalg.query() {
      ...
      %sorted =  relalg.sort %result_rel [(@edges::@dst,asc),(@result::@depth,asc)]
      %materialized = relalg.materialize %sorted[@edges::@dst, @result::@depth] => ["dst", "val"] : !subop.local_table<[dst: i64, val: i64], ["dst", "val"]>
