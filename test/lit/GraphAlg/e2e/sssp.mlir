// RUN: mlir-db-opt %s  --graphalg-set-dimensions='func=SSSP args=10x10,10x1' --lower-graphalg-to-graphalg-core --lower-graphalg-core-to-relalg > %t.mlir
...
module {
  ...
  func.func @main() {
    %result = relalg.query() {
      ...
      %edges_rel = relalg.const_relation columns:[@edges::@src({type=i64}), @edges::@dst({type=i64}), @edges::@val({type=f64})] values: [
        [1: i64, 2: i64, 1.5 : f64],[2: i64, 3: i64, 2.0 : f64],[3: i64, 4: i64, 1.0 : f64],[4: i64, 5: i64, 3.0 : f64],[1: i64, 3: i64, 5.0 : f64]
      ]
