// RUN: mlir-db-opt %s  --graphalg-set-dimensions='func=CDLP args=8x8' --lower-graphalg-to-graphalg-core --lower-graphalg-core-to-relalg > %t.mlir
...
module {
  ...
  func.func @main() {
    %result = relalg.query() {
      ...
      %materialized = relalg.materialize %result_rel [@edges::@src, @edges::@dst, @edges::@val] =>["node", "label", "val"] : !subop.local_table<[node: i64, label: i64, val: i1], ["node", "label", "val"]>
