...
// RUN: %if baseline-backend %{LINGODB_EXECUTION_MODE=BASELINE mlir-db-opt %s -split-input-file -mlir-print-debuginfo -mlir-print-local-scope --lower-graphalg-to-graphalg-core | FileCheck %s %}
