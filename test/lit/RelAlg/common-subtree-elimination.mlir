...
module @querymodule  {
  func.func @query() {
    //CHECK: %0 = relalg.basetable  {table_identifier = "table1"} columns: {col1 => @table1::@col1({type = !db.string}), col2 => @table1::@col2({type = !db.string}), col3 => @table1::@col3({type = !db.string}), col4 => @table1_u_1::@col4({type = !db.string})}
    %0 = relalg.basetable {table_identifier = "table1"} columns:{ col1 => @table1::@col1({type = !db.string}),col2 => @table1::@col2({type = !db.string}),col3 => @table1::@col3({type = !db.string})}
    //CHECK: %1 = relalg.selection %0 (%arg0: !tuples.tuple){
  	%1 = relalg.selection %0 (%arg0: !tuples.tuple) {
        %4 = tuples.getcol %arg0 @table1::@col1 : i32
    	%5 = tuples.getcol %arg0 @table1::@col2 : i32
	...
	//CHECK: %4 = relalg.crossproduct %1, %3
  	%4 = relalg.crossproduct %1, %3
  	//CHECK: %5:2 = relalg.tmp %4 [@table1::@col1,@table2::@col1,@table1::@col2,@table2::@col2,@table1_u_1::@col4] -> !tuples.tuplestream, !tuples.tuplestream

    %5 = relalg.basetable {table_identifier = "table1"} columns:{col4 => @table1_u_1::@col4({type = !db.string}), col1 => @table1_u_1::@col1({type = !db.string}),col2 => @table1_u_1::@col2({type = !db.string})}
  	%6 = relalg.selection %5 (%arg0: !tuples.tuple) {
        %C4 = tuples.getcol %arg0 @table1_u_1::@col1 : i32
    	%C5 = tuples.getcol %arg0 @table1_u_1::@col2 : i32
    	%C6 = db.compare eq %C4 : i32, %C5 : i32
    ...
    //CHECK: %8 = relalg.selection %7 (%arg0: !tuples.tuple){
  	%11 = relalg.selection %10 (%arg0: !tuples.tuple) {
    	%C4 = tuples.getcol %arg0 @table1_u_1::@col4 : i32
    	%C5 = tuples.getcol %arg0 @table2_u_1::@col2 : i32
    	%C6 = db.compare eq %C4 : i32, %C5 : i32
    	tuples.return %C6 : i1
    }

  	//CHECK: %9 = relalg.materialize %8 [] => [] : !subop.local_table<[], []>
    %res_table = relalg.materialize %11 [] => [] : !subop.local_table<[],[]>
    subop.set_result 0 %res_table : !subop.local_table<[],[]>
    return
  }
}