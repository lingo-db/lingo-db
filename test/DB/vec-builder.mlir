 ...
 module {
	...
	func @main () {
	    ...
	    %vector = db.create_ds !db.vector<!test_table_tuple>
        ...
        db.for %record_batch in %0 : !db.iterable<!db.record_batch<!test_table_tuple>,table_chunk_iterator>{
            db.for %row in %record_batch : !db.record_batch<!test_table_tuple>{
                ...
                db.ds_append %vector : !db.vector<!test_table_tuple> , %packed : !test_table_tuple
                db.yield
            }
            db.yield
        }
        db.for %row in %vector : !db.vector<!test_table_tuple> {
            %1,%2,%3,%4,%5,%6,%7,%8,%9 = util.unpack %row : !test_table_tuple -> !db.nullable<!db.string>,!db.nullable<f32>,!db.nullable<f64>,!db.nullable<!db.decimal<5,2>>,!db.nullable<i32>,!db.nullable<i64>,!db.nullable<i1>,!db.nullable<!db.date<day>>,!db.nullable<!db.date<millisecond>>
