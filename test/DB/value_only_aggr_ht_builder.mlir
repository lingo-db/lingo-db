...
//CHECK: string("---------------")
 module {
	...
	func @main () {
        ...
        %ht = db.create_ds %initial : tuple<i32,i32> ->  !db.aggr_ht<tuple<>,tuple<i32,i32>>
        db.ht_insert_reduce %ht :  !db.aggr_ht<tuple<>,tuple<i32,i32>>, %empty_key : tuple<>, %val1 : tuple<i32,i32> reduce: (%curr:tuple<i32,i32>, %new:tuple<i32,i32>) {
         ...
         db.ht_insert_reduce %ht :  !db.aggr_ht<tuple<>,tuple<i32,i32>>, %empty_key : tuple<>, %val2 : tuple<i32,i32> reduce: (%curr:tuple<i32,i32>, %new:tuple<i32,i32>) {
             %curr1,%curr2 = util.unpack %curr : tuple<i32,i32> -> i32,i32
             %new1,%new2 = util.unpack %new : tuple<i32,i32> -> i32,i32
             %add1 = db.add %curr1 : i32,%new1 : i32
             %mul1 = db.mul %curr2 : i32,%new2 : i32
         ...
         db.ht_insert_reduce %ht :  !db.aggr_ht<tuple<>,tuple<i32,i32>>, %empty_key : tuple<>, %val3 : tuple<i32,i32> reduce: (%curr:tuple<i32,i32>, %new:tuple<i32,i32>) {
             %curr1,%curr2 = util.unpack %curr : tuple<i32,i32> -> i32,i32
             %new1,%new2 = util.unpack %new : tuple<i32,i32> -> i32,i32
             %add1 = db.add %curr1 : i32,%new1 : i32
             %mul1 = db.mul %curr2 : i32,%new2 : i32
          ...
          db.ht_insert_reduce %ht :  !db.aggr_ht<tuple<>,tuple<i32,i32>>, %empty_key : tuple<>, %val4 : tuple<i32,i32> reduce: (%curr:tuple<i32,i32>, %new:tuple<i32,i32>) {
              %curr1,%curr2 = util.unpack %curr : tuple<i32,i32> -> i32,i32
              %new1,%new2 = util.unpack %new : tuple<i32,i32> -> i32,i32
              %add1 = db.add %curr1 : i32,%new1 : i32
              %mul1 = db.mul %curr2 : i32,%new2 : i32
