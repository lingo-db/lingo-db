...
//CHECK: string("---------------")
 module {
	...
	func @main () {
        ...
        %entry1 = util.pack %empty_key,%val1 :tuple<>,tuple<i32,i32> -> tuple<tuple<>,tuple<i32,i32>>
        %entry2 = util.pack %empty_key,%val2 :tuple<>,tuple<i32,i32> -> tuple<tuple<>,tuple<i32,i32>>
        %entry3 = util.pack %empty_key,%val3 :tuple<>,tuple<i32,i32> -> tuple<tuple<>,tuple<i32,i32>>
        %entry4 = util.pack %empty_key,%val4 :tuple<>,tuple<i32,i32> -> tuple<tuple<>,tuple<i32,i32>>


        %initial = util.pack %zero, %one : i32,i32 -> tuple<i32,i32>

        %aggr_ht_builder= db.create_aggr_ht_builder %initial : tuple<i32,i32>  -> !db.aggr_ht_builder<tuple<>,tuple<i32,i32>, tuple<i32,i32>>
        %builder1= db.builder_merge %aggr_ht_builder : !db.aggr_ht_builder<tuple<>,tuple<i32,i32>, tuple<i32,i32>>, %entry1 : !entry_type (%curr:tuple<i32,i32>, %new:tuple<i32,i32>) {
