...
module {
    func @main () {
         ...
         %tuple = util.pack %int32_const, %int64_const, %bool_true_const, %decimal2_const, %date_const, %timestamp_const, %str_const
          : !db.int<32>,!db.int<64>,i1,!db.decimal<15,2>,!db.date<day>,!db.timestamp<second>,!db.string -> tuple<!db.int<32>, !db.int<64>,i1,!db.decimal<15,2>,!db.date<day>,!db.timestamp<second>,!db.string>
         %tuple_hash = db.hash %tuple : tuple<!db.int<32>, !db.int<64>,i1,!db.decimal<15,2>,!db.date<day>,!db.timestamp<second>,!db.string>
