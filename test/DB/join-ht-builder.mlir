...
//CHECK: string("---------------")
 module {
	...
	func @main () {
        ...
        %entry1 = util.pack %key1,%val1 :tuple<!db.string,i32>,tuple<i32,i32> -> tuple<tuple<!db.string,i32>,tuple<i32,i32>>
        %entry2 = util.pack %key2,%val2 :tuple<!db.string,i32>,tuple<i32,i32> -> tuple<tuple<!db.string,i32>,tuple<i32,i32>>
        %entry3 = util.pack %key3,%val3 :tuple<!db.string,i32>,tuple<i32,i32> -> tuple<tuple<!db.string,i32>,tuple<i32,i32>>
        %entry4 = util.pack %key4,%val4 :tuple<!db.string,i32>,tuple<i32,i32> -> tuple<tuple<!db.string,i32>,tuple<i32,i32>>


        %join_ht_builder= db.create_join_ht_builder : !db.join_ht_builder<tuple<!db.string,i32>,tuple<i32,i32>>
        %builder1= db.builder_merge %join_ht_builder : !db.join_ht_builder<tuple<!db.string,i32>,tuple<i32,i32>>, %entry1 : !entry_type
        %builder2= db.builder_merge %builder1 : !db.join_ht_builder<tuple<!db.string,i32>,tuple<i32,i32>>, %entry2 : !entry_type
        %builder3= db.builder_merge %builder2 : !db.join_ht_builder<tuple<!db.string,i32>,tuple<i32,i32>>, %entry3 : !entry_type
        %builder4= db.builder_merge %builder3 : !db.join_ht_builder<tuple<!db.string,i32>,tuple<i32,i32>>, %entry4 : !entry_type
        %ht  = db.builder_build %builder4 : !db.join_ht_builder<tuple<!db.string,i32>,tuple<i32,i32>> -> !db.join_ht<tuple<!db.string,i32>,tuple<i32,i32>>
