...
//CHECK: string("---------------")
 module {
	...
	func @main (%execution_context: memref<i8>) {
        ...
        %aggr_ht_builder= db.create_aggr_ht_builder (%curr:tuple<!db.int<32>,!db.int<32>>, %new:tuple<!db.int<32>,!db.int<32>>) {
           ...
           db.dump %curr1 : !db.int<32>
           db.dump %curr2 : !db.int<32>
           db.dump %new1 : !db.int<32>
           db.dump %new2 : !db.int<32>
