...
//CHECK: string("---------------")
 module {
	...
	func @main () {
        ...
        %ht = db.create_ds %initial : tuple<i32,i32> -> !db.aggr_ht<tuple<!db.nullable<!db.string>,i32>,tuple<i32,i32>>
        db.ht_insert_reduce %ht : !db.aggr_ht<tuple<!db.nullable<!db.string>,i32>,tuple<i32,i32>>, %key1 : tuple<!db.nullable<!db.string>,i32>, %val1 : tuple<i32,i32> eq: (%left : tuple<!db.nullable<!db.string>,i32>,%right : tuple<!db.nullable<!db.string>,i32>){
         ...
         db.ht_insert_reduce %ht : !db.aggr_ht<tuple<!db.nullable<!db.string>,i32>,tuple<i32,i32>>, %key2 : tuple<!db.nullable<!db.string>,i32>, %val2 : tuple<i32,i32> eq: (%left : tuple<!db.nullable<!db.string>,i32>,%right : tuple<!db.nullable<!db.string>,i32>){
             %l1,%l2 = util.unpack %left : tuple<!db.nullable<!db.string>,i32> -> !db.nullable<!db.string>,i32
             %r1,%r2 = util.unpack %right : tuple<!db.nullable<!db.string>,i32> -> !db.nullable<!db.string>,i32
             %cmp1 = db.compare "eq" %l1 : !db.nullable<!db.string>, %r1 : !db.nullable<!db.string>
             %cmp2 = db.compare "eq" %l2 : i32, %r2 : i32
         ...
         db.ht_insert_reduce %ht : !db.aggr_ht<tuple<!db.nullable<!db.string>,i32>,tuple<i32,i32>>, %key3 : tuple<!db.nullable<!db.string>,i32>, %val3 : tuple<i32,i32> eq: (%left : tuple<!db.nullable<!db.string>,i32>,%right : tuple<!db.nullable<!db.string>,i32>){
             %l1,%l2 = util.unpack %left : tuple<!db.nullable<!db.string>,i32> -> !db.nullable<!db.string>,i32
             %r1,%r2 = util.unpack %right : tuple<!db.nullable<!db.string>,i32> -> !db.nullable<!db.string>,i32
             %cmp1 = db.compare "eq" %l1 : !db.nullable<!db.string>, %r1 : !db.nullable<!db.string>
             %cmp2 = db.compare "eq" %l2 : i32, %r2 : i32
          ...
          db.ht_insert_reduce %ht : !db.aggr_ht<tuple<!db.nullable<!db.string>,i32>,tuple<i32,i32>>, %key4 : tuple<!db.nullable<!db.string>,i32>, %val4 : tuple<i32,i32> eq: (%left : tuple<!db.nullable<!db.string>,i32>,%right : tuple<!db.nullable<!db.string>,i32>){
              %l1,%l2 = util.unpack %left : tuple<!db.nullable<!db.string>,i32> -> !db.nullable<!db.string>,i32
              %r1,%r2 = util.unpack %right : tuple<!db.nullable<!db.string>,i32> -> !db.nullable<!db.string>,i32
              %cmp1 = db.compare "eq" %l1 : !db.nullable<!db.string>, %r1 : !db.nullable<!db.string>
              %cmp2 = db.compare "eq" %l2 : i32, %r2 : i32
