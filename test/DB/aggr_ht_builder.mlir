...
//CHECK: string("---------------")
 module {
	...
	func @main (%execution_context:  !util.generic_memref<i8>) {
        ...
        } -> !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>
        %builder1= db.builder_merge %aggr_ht_builder : !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>, %entry1 : !entry_type -> !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>
        db.dump %str_const : !db.string
        %builder2= db.builder_merge %builder1 : !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>, %entry2 : !entry_type -> !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>
        db.dump %str_const : !db.string
        %builder3= db.builder_merge %builder2 : !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>, %entry3 : !entry_type -> !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>
        db.dump %str_const : !db.string
        %builder4= db.builder_merge %builder3 : !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>, %entry4 : !entry_type -> !db.aggr_ht_builder<tuple<!db.string<nullable>,!db.int<32>>,tuple<!db.int<32>,!db.int<32>>, tuple<!db.int<32>,!db.int<32>>>
        db.dump %str_const : !db.string
