...
module {
  func @main() -> !db.table {
    ...
    %3 = relalg.selection %2 (%arg0: !relalg.tuple){
      %8 = relalg.getattr %arg0 @orders::@o_orderkey : i32
      %9 = relalg.getattr %arg0 @lineitem::@l_orderkey : i32
      %10 = db.compare eq %8 : i32, %9 : i32
      %11 = db.constant("MAIL") : !db.string
      %12 = db.constant("SHIP") : !db.string
      %13 = relalg.getattr %arg0 @lineitem::@l_shipmode : !db.string
      %14 = db.oneof %13 : !db.string ? %11, %12 : !db.string, !db.string
      %15 = relalg.getattr %arg0 @lineitem::@l_commitdate : !db.date<day>
      %16 = relalg.getattr %arg0 @lineitem::@l_receiptdate : !db.date<day>
      %17 = db.compare lt %15 : !db.date<day>, %16 : !db.date<day>
      %18 = relalg.getattr %arg0 @lineitem::@l_shipdate : !db.date<day>
      %19 = relalg.getattr %arg0 @lineitem::@l_commitdate : !db.date<day>
      %20 = db.compare lt %18 : !db.date<day>, %19 : !db.date<day>
      %21 = relalg.getattr %arg0 @lineitem::@l_receiptdate : !db.date<day>
    ...
    %4 = relalg.map @map0 %3 (%arg0: !relalg.tuple){
      %8 = relalg.getattr %arg0 @orders::@o_orderpriority : !db.string
      ...
      %16 = relalg.addattr %arg0, @tmp_attr3({type = i32}) %15
      %17 = relalg.getattr %16 @orders::@o_orderpriority : !db.string
      ...
      %25 = relalg.addattr %16, @tmp_attr1({type = i32}) %24
