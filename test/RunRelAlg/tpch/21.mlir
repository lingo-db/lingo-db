...
module {
  func @main() -> !dsa.table {
    ...
    %7 = relalg.selection %6 (%arg0: !relalg.tuple){
      ...
      %13 = relalg.getcol %arg0 @l1::@l_suppkey : i32
      %14 = db.compare eq %12 : i32, %13 : i32
      %15 = relalg.getcol %arg0 @orders::@o_orderkey : i32
      %16 = relalg.getcol %arg0 @l1::@l_orderkey : i32
      ...
      %21 = relalg.getcol %arg0 @l1::@l_receiptdate : !db.date<day>
      %22 = relalg.getcol %arg0 @l1::@l_commitdate : !db.date<day>
      ...
      %25 = relalg.selection %24 (%arg1: !relalg.tuple){
        %38 = relalg.getcol %arg1 @l2::@l_orderkey : i32
        %39 = relalg.getcol %arg1 @l1::@l_orderkey : i32
        %40 = db.compare eq %38 : i32, %39 : i32
        %41 = relalg.getcol %arg1 @l2::@l_suppkey : i32
        %42 = relalg.getcol %arg1 @l1::@l_suppkey : i32
      ...
      %28 = relalg.selection %27 (%arg1: !relalg.tuple){
        %38 = relalg.getcol %arg1 @l3::@l_orderkey : i32
        %39 = relalg.getcol %arg1 @l1::@l_orderkey : i32
        %40 = db.compare eq %38 : i32, %39 : i32
        %41 = relalg.getcol %arg1 @l3::@l_suppkey : i32
        %42 = relalg.getcol %arg1 @l1::@l_suppkey : i32
        %43 = db.compare neq %41 : i32, %42 : i32
        %44 = relalg.getcol %arg1 @l3::@l_receiptdate : !db.date<day>
        %45 = relalg.getcol %arg1 @l3::@l_commitdate : !db.date<day>
