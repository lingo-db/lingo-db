...
module @querymodule{
    func  @main ()  -> !db.table{
        ...
        %3 = relalg.selection %1(%2: !relalg.tuple) {
            ...
            %10 = relalg.basetable @lineitem { table_identifier="lineitem", rows=600572 , pkey=["l_orderkey","l_linenumber"]} columns: {l_orderkey => @l_orderkey({type=!db.int<64>}),
            ...
            %12 = relalg.selection %10(%11: !relalg.tuple) {
                %13 = relalg.getattr %11 @lineitem::@l_orderkey : !db.int<64>
                %14 = relalg.getattr %2 @orders::@o_orderkey : !db.int<64>
