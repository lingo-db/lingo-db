  ...
  func @main() -> !dsa.table {
    ...
    %9 = relalg.selection %8 (%arg0: !relalg.tuple){
      ...
      %42 = relalg.selection %41 (%arg1: !relalg.tuple){
        ...
        %48 = relalg.getcol %arg1 @partsupp::@ps_partkey : i32
        %49 = db.compare eq %47 : i32, %48 : i32
        %50 = relalg.getcol %arg1 @supplier::@s_suppkey : i32
        %51 = relalg.getcol %arg1 @partsupp::@ps_suppkey : i32
        %52 = db.compare eq %50 : i32, %51 : i32
        %53 = relalg.getcol %arg1 @supplier::@s_nationkey : i32
        %54 = relalg.getcol %arg1 @nation::@n_nationkey : i32
        %55 = db.compare eq %53 : i32, %54 : i32
        %56 = relalg.getcol %arg1 @nation::@n_regionkey : i32
        %57 = relalg.getcol %arg1 @region::@r_regionkey : i32
        %58 = db.compare eq %56 : i32, %57 : i32
        %59 = relalg.getcol %arg1 @region::@r_name : !db.string
