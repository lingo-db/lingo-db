...
module {
  func @main() -> !db.table {
    ...
    %4 = relalg.aggregation @aggr0 %3 [@lineitem::@l_suppkey] (%arg0: !relalg.tuplestream,%arg1: !relalg.tuple){
      ...
      %10 = relalg.addattr %arg1, @tmp_attr0({type = !db.nullable<!db.decimal<15, 2>>}) %9
    ...
    %6 = relalg.selection %5 (%arg0: !relalg.tuple){
      ...
      %12 = relalg.getattr %arg0 @aggr0::@tmp_attr0 : !db.nullable<!db.decimal<15, 2>>
      ...
      %16 = relalg.aggregation @aggr1 %15 [@lineitem::@l_suppkey] (%arg1: !relalg.tuplestream,%arg2: !relalg.tuple){
        %21 = relalg.aggrfn sum @map1::@tmp_attr3 %arg1 : !db.nullable<!db.decimal<15, 2>>
        %22 = relalg.addattr %arg2, @tmp_attr2({type = !db.nullable<!db.decimal<15, 2>>}) %21
      ...
      %19 = db.compare eq %12 : !db.nullable<!db.decimal<15, 2>>, %18 : !db.nullable<!db.decimal<15, 2>>
