...
module {
  func @main() -> !db.table {
    ...
    %1 = relalg.selection %0 (%arg0: !relalg.tuple){
      %5 = relalg.getattr %arg0 @lineitem::@l_shipdate : !db.date<day>
      %6 = db.constant("1994-01-01") : !db.date<day>
      %7 = db.compare gte %5 : !db.date<day>, %6 : !db.date<day>
      %8 = relalg.getattr %arg0 @lineitem::@l_shipdate : !db.date<day>
    ...
    %2 = relalg.map @map0 %1 (%arg0: !relalg.tuple){
      %5 = relalg.getattr %arg0 @lineitem::@l_extendedprice : !db.decimal<15, 2>
      %6 = relalg.getattr %arg0 @lineitem::@l_discount : !db.decimal<15, 2>
      %7 = db.mul %5 : !db.decimal<15, 2>, %6 : !db.decimal<15, 2>
      %8 = relalg.addattr %arg0, @tmp_attr1({type = !db.decimal<15, 2>}) %7
      relalg.return %8 : !relalg.tuple
    }
    %3 = relalg.aggregation @aggr0 %2 [] (%arg0: !relalg.tuplestream,%arg1: !relalg.tuple){
      %5 = relalg.aggrfn sum @map0::@tmp_attr1 %arg0 : !db.nullable<!db.decimal<15, 2>>
      %6 = relalg.addattr %arg1, @tmp_attr0({type = !db.nullable<!db.decimal<15, 2>>}) %5
