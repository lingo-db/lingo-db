...
module {
  func @main() -> !dsa.table {
    ...
    %2 = relalg.map @map0 %1 computes : [@tmp_attr5({type = !db.decimal<15, 6>}),@tmp_attr3({type = !db.decimal<15, 4>})] (%arg0: !relalg.tuple){
      ...
      %14 = db.mul %10 : !db.decimal<15, 4>, %13 : !db.decimal<15, 2>
    ...
    %3 = relalg.aggregation @aggr0 %2 [@lineitem::@l_returnflag,@lineitem::@l_linestatus] computes : [@tmp_attr8({type = !db.decimal<15, 2>}),@tmp_attr9({type = i64}),@tmp_attr7({type = !db.decimal<15, 2>}),@tmp_attr4({type = !db.decimal<15, 6>}),@tmp_attr2({type = !db.decimal<15, 4>}),@tmp_attr1({type = !db.decimal<15, 2>}),@tmp_attr6({type = !db.decimal<15, 2>}),@tmp_attr0({type = !db.decimal<15, 2>})] (%arg0: !relalg.tuplestream,%arg1: !relalg.tuple){
      ...
      %9 = relalg.aggrfn sum @map0::@tmp_attr5 %arg0 : !db.decimal<15, 6>
      %10 = relalg.aggrfn sum @map0::@tmp_attr3 %arg0 : !db.decimal<15, 4>
      ...
      relalg.return %6, %7, %8, %9, %10, %11, %12, %13 : !db.decimal<15, 2>, i64, !db.decimal<15, 2>, !db.decimal<15, 6>, !db.decimal<15, 4>, !db.decimal<15, 2>, !db.decimal<15, 2>, !db.decimal<15, 2>
    }
