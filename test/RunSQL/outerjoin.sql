--//RUN: sql-to-mlir %s | mlir-db-opt --relalg-extract-nested-operators --relalg-decompose-lambdas --relalg-implicit-to-explicit-joins --relalg-pushdown --relalg-unnesting --relalg-optimize-implementations | mlir-db-opt -relalg-to-db -canonicalize | run-mlir "-" %S/../../resources/data/uni | FileCheck %s
