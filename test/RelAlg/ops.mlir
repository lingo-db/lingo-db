...
module{
// CHECK: %0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string})] values: ["A", "B"]
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.semijoin left %0, %1  (%arg0: !relalg.tuple) {
%2 = relalg.semijoin left %0, %1  (%arg0: !relalg.tuple) {
    //CHECK:    %3 = db.constant( "true" ) : !db.bool
	%3 = db.constant( "true" ) : !db.bool
	//CHECK:    relalg.return %3 : !db.bool
	relalg.return %3 : !db.bool
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.semijoin right %0, %1  (%arg0: !relalg.tuple) {
%2 = relalg.semijoin right %0, %1  (%arg0: !relalg.tuple) {
    //CHECK:    %3 = db.constant( "true" ) : !db.bool
	%3 = db.constant( "true" ) : !db.bool
	//CHECK:    relalg.return %3 : !db.bool
	relalg.return %3 : !db.bool
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.antisemijoin left %0, %1  (%arg0: !relalg.tuple) {
%2 = relalg.antisemijoin left %0, %1  (%arg0: !relalg.tuple) {
    //CHECK:    %3 = db.constant( "true" ) : !db.bool
	%3 = db.constant( "true" ) : !db.bool
	//CHECK:    relalg.return %3 : !db.bool
	relalg.return %3 : !db.bool
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.antisemijoin right %0, %1  (%arg0: !relalg.tuple) {
%2 = relalg.antisemijoin right %0, %1  (%arg0: !relalg.tuple) {
    //CHECK:    %3 = db.constant( "true" ) : !db.bool
	%3 = db.constant( "true" ) : !db.bool
	//CHECK:    relalg.return %3 : !db.bool
	relalg.return %3 : !db.bool
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.outerjoin left %0, %1  (%arg0: !relalg.tuple) {
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.outerjoin right %0, %1  (%arg0: !relalg.tuple) {
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.markjoin left @markjoin @markattr({type = !db.string}) %0, %1  (%arg0: !relalg.tuple) {
%2 = relalg.markjoin left @markjoin @markattr({type = !db.string}) %0, %1  (%arg0: !relalg.tuple) {
    //CHECK:    %3 = db.constant( "true" ) : !db.bool
	%3 = db.constant( "true" ) : !db.bool
	//CHECK:    relalg.return %3 : !db.bool
	relalg.return %3 : !db.bool
...
%0 = relalg.const_relation @constrel  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  attributes: [@attr1({type = !db.string}),@attr2({type = !db.string})] values: [["A1","B1"], ["A2","B2"]]
//CHECK: %2 = relalg.markjoin right @markjoin @markattr({type = !db.string}) %0, %1  (%arg0: !relalg.tuple) {
%2 = relalg.markjoin right @markjoin @markattr({type = !db.string}) %0, %1  (%arg0: !relalg.tuple) {
    //CHECK:    %3 = db.constant( "true" ) : !db.bool
	%3 = db.constant( "true" ) : !db.bool
	//CHECK:    relalg.return %3 : !db.bool
	relalg.return %3 : !db.bool
