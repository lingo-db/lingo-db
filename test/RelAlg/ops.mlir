...
module{
// CHECK: %0 = relalg.const_relation @constrel  columns : [@attr1({type = !db.string}),@attr2({type = !db.string})]
%0 = relalg.const_relation @constrel  columns : [@attr1({type = !db.string}),@attr2({type = !db.string})] values : [["A","B"],["C","D"]]
}
// -----
...
// -----
module{
%0 = relalg.const_relation @constrel  columns : [@attr1({type = i1})] values : ["true", "false"]
//CHECK: %1 = relalg.selection %0 (%arg0: !relalg.tuple)
%1 = relalg.selection %0 (%arg0: !relalg.tuple) {
    //CHECK:    %2 = relalg.getcol %arg0 @constrel::@attr1 : i1
	%2 = relalg.getcol %arg0 @constrel::@attr1 : i1
...
// -----
module{
%0 = relalg.const_relation @constrel  columns : [@attr1({type = !db.string}),@attr2({type = !db.string})] values : [["A1","B1"], ["A2","B2"]]
%1 = relalg.const_relation @constrel2  columns : [@attr1({type = !db.string}),@attr2({type = !db.string})] values : [["A1","B1"], ["A2","B2"]]
...
// -----
module{
%0 = relalg.const_relation @constrel  columns : [@attr1({type = i32}),@attr2({type = i32})] values : [[1,1], [0,0]]
...
// -----
module{
%0 = relalg.const_relation @constrel  columns : [@attr1({type = !db.string})] values : ["A"]
