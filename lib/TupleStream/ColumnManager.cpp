...
ColumnDefAttr ColumnManager::createDef(SymbolRefAttr name, Attribute fromExisting) {
   ...
   return mlir::tuples::ColumnDefAttr::get(context, name, attribute, fromExisting);
}
ColumnDefAttr ColumnManager::createDef(StringRef scope, StringRef name, Attribute fromExisting) {
   ...
   return mlir::tuples::ColumnDefAttr::get(context, SymbolRefAttr::get(context, scope, nested), attribute, fromExisting);
}
