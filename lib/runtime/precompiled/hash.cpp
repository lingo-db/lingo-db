...
uint64 inline CityHash64WithSeeds(const char *s, size_t len,
                                  uint64 seed0, uint64 seed1) {
   return HashLen16(CityHash64(s, len) - seed0, seed1);
}
uint64 inline CityHash64WithSeed(const char *s, size_t len, uint64 seed) {
...
uint64_t _mlir_ciface_hash_int_128(__int128 val) {
   return cityhash::CityHash64((char*)&val,sizeof(__int128));
}
uint64_t _mlir_ciface_hash_int_64(uint64_t val) {
   return cityhash::CityHash64((char*)&val,sizeof(uint64_t));
}
uint64_t _mlir_ciface_hash_int_32(uint32_t val) {
   return cityhash::CityHash64((char*)&val,sizeof(uint32_t));
}
uint64_t _mlir_ciface_hash_int_16(uint16_t val) {
   return cityhash::CityHash64((char*)&val,sizeof(uint16_t));
}
uint64_t _mlir_ciface_hash_int_8(uint8_t val) {
   return cityhash::CityHash64((char*)&val,sizeof(uint8_t));
}
uint64_t _mlir_ciface_hash_bool(bool val) {
   return cityhash::CityHash64((char*)&val,sizeof(bool));
}
uint64_t _mlir_ciface_hash_float_32(float val) {
   return cityhash::CityHash64((char*)&val,sizeof(float));
}
uint64_t _mlir_ciface_hash_float_64(double val) {
   return cityhash::CityHash64((char*)&val,sizeof(double));
}

uint64_t _mlir_ciface_hash_binary(runtime::String* val) {
   return cityhash::CityHash64(val->data(),val->len());
}
}