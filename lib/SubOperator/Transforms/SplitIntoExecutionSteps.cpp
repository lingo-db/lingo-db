...
class SplitIntoExecutionSteps : public mlir::PassWrapper<SplitIntoExecutionSteps, mlir::OperationPass<mlir::ModuleOp>> {
   ...
   void runOnOperation() override {
      ...
      getOperation()->walk([&](mlir::subop::ExecutionGroupOp executionGroup) {
...
mlir::subop::createSplitIntoExecutionStepsPass() { return std::make_unique<SplitIntoExecutionSteps>(); }
